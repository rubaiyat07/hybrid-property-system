    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-1/2 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <div class="mt-2 px-2 py-3">
                ...
                <form id="bulkApproveForm" action="<?php echo e(route('admin.property.bulk-approve')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\xampp\htdocs\Web_Dev\Git_Demo\hybrid-property-system\resources\views/partials/admin/property/bulk-approve-modal.blade.php ENDPATH**/ ?>