    ...
    <div class="page-header mb-6">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('landlord.tenants.create') }}" class="btn-primary">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('landlord.tenants.show', $tenant->id) }}" class="text-indigo-600 hover:text-indigo-900" title="View Details">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('landlord.tenants.edit', $tenant->id) }}" class="text-green-600 hover:text-green-900" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="{{ route('landlord.tenants.message', $tenant->id) }}" class="text-blue-600 hover:text-blue-900" title="Send Message">
